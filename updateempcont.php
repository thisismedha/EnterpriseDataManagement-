...
background-size: fit;">
    <div class="navbar" style="border: black; border-radius: 1px;">
        <ul>
            ...
            font-weight: 700;">Employee Contact Details</h4>
        </ul>
    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$connection) {
        ...
        if (isset($_POST['apply'])) {
                $sql = "SELECT e.employeeid AS \"Employee ID\",
                                e.fname||' '||e.mname||' '||e.lname AS Name,
                                e.department AS \"Department\",
                                employeephone AS \"Employee Contact\"
                                    FROM employees e
                                    INNER JOIN employee_phones ep
                            on e.employeeid = ep.employeeid
                            WHERE e.employeeid = :em";

        } 
        else if (isset($_POST['remove'])) {
            $sql = "BEGIN DELETECONTACT(:em); END;";
        }        
        ...
        if ($row > 0) {
            ...
            // <div class="container" style="border: black; border-radius: 1px;">
            //     <br>
            //     <form action="udcontact.php" method="POST">          
            //         <div style="display: inline-block;">
            //             <form style="margin-left: 450px;" action="/display_data" method="GET">
            ...
            //                 <button type="submit" style="background-color: #4CAF50;" class="btn btn-primary">Update</button>
            //             </form>
            //         </div>
            //     </form>
            // </div>';
